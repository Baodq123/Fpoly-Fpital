	...
	<section class="ftco-section">
		<div class="container">
			<div class="row">
                ...
                <h2 class="mb-3 font-weight-bold"><?php echo e($detail->title); ?></h2>
                <p class="font-weight-bold"><?php echo e($detail->description); ?></p>
					<p>
						<img src="Fpital/images/image_4.jpg" alt="" class="img-fluid">
                    </p>
                <p><?php echo e($detail->content); ?></p>
					...
					<div class="pt-5 mt-5">
						...
						<ul class="comment-list">
							...
							<li class="comment">
								<div class="vcard bio">
								<img src="<?php echo e($cm->user->image); ?>" alt="Image placeholder">
								</div>
								<div class="comment-body">
                                <h3><?php echo e($cm->user->name); ?></h3>
								<div class="meta"><?php echo e($cm->created_at); ?></div>
                                    <p><?php echo e($cm->message); ?></p>
						...
						<div class="comment-form-wrap">
							<h3>Bình luận</h3>
                            <form action="comment-<?php echo e($detail->id); ?>" method="post" role="form">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.blog-detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\fpoly\ĐỒ ÁN TỐT NGHIỆP\adminlte\resources\views/site/blog-detail.blade.php ENDPATH**/ ?>