...
<!-- Mirrored from colorlib.com/preview/theme/dentacare/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Oct 2019 03:59:21 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<title>Chi tiết bài viết</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<?php echo $__env->make('layouts.style-index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</head>
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ftco-animate">
					<h2 class="mb-3 font-weight-bold">We Love WordPress Themes</h2>
					...
					<p>
						<img src="Fpital/images/image_5.jpg" alt="" class="img-fluid">
					</p>
					...
					<div class="tag-widget post-tag-container mb-5 mt-5">
						<div class="tagcloud" style="margin-top: -30px;">
							<a href="#" class="tag-cloud-link"><i class="fas fa-exclamation" style="color: red"></i> Báo lỗi bài viết</a>
						</div>
					</div>
					<div class="pt-5 mt-5">
						<h3 class="mb-5" style="margin-top: -70px;">6 Bình luận</h3>
						<ul class="comment-list">
							<li class="comment">
								<div class="vcard bio">
									<img src="Fpital/images/person_1.jpg" alt="Image placeholder">
								</div>
						...
						<div class="comment-form-wrap">
							...
							<form action="#">
								<div class="form-group">
									<textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Nhập nội dung bình luận.."></textarea>
								</div>
								<div class="form-group">
...
<div class="sidebar-box ftco-animate">
	<div class="categories">
		<h3>Danh mục</h3>
		<li><a href="#">Tin tức y khoa <span>(12)</span></a></li>
		<li><a href="#">Hoạt động của bệnh viện <span>(22)</span></a></li>
	</div>
</div>

<div class="sidebar-box ftco-animate" style="margin-top: -50px;">
	<h3>Bài viết có liên quan</h3>
...
<div class="block-21 mb-4 d-flex">
	<a class="blog-img mr-4" style="background-image: url(Fpital/images/image_2.jpg);"></a>
	<div class="text">
		<h5 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h5>
<!-- <div class="meta">
<div><a href="#"><span class="icon-calendar"></span> July 12, 2018</a></div>
...
<div class="block-21 mb-4 d-flex">
	<a class="blog-img mr-4" style="background-image: url(Fpital/images/image_3.jpg);"></a>
	<div class="text">
		<h5 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h5>
<!-- <div class="meta">
<div><a href="#"><span class="icon-calendar"></span> July 12, 2018</a></div>
...
<footer class="ftco-footer ftco-bg-dark" style="margin-top: -50px;">
	...
	<!-- Mirrored from colorlib.com/preview/theme/dentacare/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Oct 2019 03:59:21 GMT -->
	</html><?php /**PATH E:\fpoly\ĐỒ ÁN TỐT NGHIỆP\adminlte\resources\views/layouts/detail-layout.blade.php ENDPATH**/ ?>