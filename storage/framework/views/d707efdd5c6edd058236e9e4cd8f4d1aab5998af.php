				...
				<form action="<?php echo e(route('post.edit', ['id' => $model->id])); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<span class="text-danger"><?php echo e($errors->first('publish_date', $model->publish_date)); ?></span>
							<?php endif; ?>
						</div>
						<div class="form-group">
							<label>Tác giả</label>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\fpoly\ĐỒ ÁN TỐT NGHIỆP\adminlte\resources\views/post/edit-post.blade.php ENDPATH**/ ?>