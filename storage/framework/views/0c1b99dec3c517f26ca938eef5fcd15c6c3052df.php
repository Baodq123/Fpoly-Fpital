      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
            <img src="AdminLTE/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image" width="30px;">
          </a>
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Tổng số hồ sơ</span>
                  <span class="info-box-number">
                    <?php 
...
<?php /**PATH C:\xampp\htdocs\adminlte\resources\views/welcome.blade.php ENDPATH**/ ?>