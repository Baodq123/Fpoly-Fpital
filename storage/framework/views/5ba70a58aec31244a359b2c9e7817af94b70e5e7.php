...
<div class="col-md-3">
<p><span>Địa chỉ:</span> <a href="tel://1234567920">Số 33 Nguyễn Hoàng, P. Mỹ Đình 2, Q. Nam Từ Liêm, Hà Nội</a></p>
</div>


<div class="col-md-3">
<p><span>Hotline:</span> <a href="tel://1234567920">0969456147 </a></p>
</div>


<div class="col-md-3">
<p><span>Email:</span> <a href="tel://1234567920">benhvienfpital@gmail.com </a></p>
</div>

<div class="col-md-3">
<p><span>Website:</span> <a href="#">benhvienfpital.vn </a></p>
</div>
</div>
<div class="row block-9">
<div class="col-md-6 pr-md-5">
<form action="<?php echo e(route('lien-he.add')); ?>" method="post" role="form">
<?php echo csrf_field(); ?>
...
<div class="form-group">
<input name="phone" type="text" class="form-control" placeholder="Số điện thọai">
</div>
<div class="form-group">
<textarea  name="message" id="" cols="30" rows="7" class="form-control" placeholder="Nội dung"></textarea>
</div>
<div class="form-group">
<button type="submit" class="btn btn-primary button-call">Gửi đi</button>
</div>
</form>
</div>
<div class="col-md-6">
...
<?php echo $__env->make('layouts.contact', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\FPT POLY\Dự Án 2\test\resources\views/site/contact.blade.php ENDPATH**/ ?>