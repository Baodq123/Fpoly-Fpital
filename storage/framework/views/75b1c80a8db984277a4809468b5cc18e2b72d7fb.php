    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
             <?php if(Auth::check()): ?>
              <span style="color: white;" class="d-block"><?php echo e(Auth::user()->name); ?></span>
              <?php endif; ?>
          </div>
        </div>
        ...
        <nav class="mt-2">
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('post')); ?>" class="nav-link">
                  <p>Tất cả bài viết</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('post.add')); ?>" class="nav-link">
                  <p>Thêm bài viết</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('errorpost')); ?>" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('doctor')); ?>" class="nav-link">
                  <p>Danh sách bác sỹ</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('doctor.add')); ?>" class="nav-link">
                  <p>Thêm bác sỹ</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('ratedoctor')); ?>" class="nav-link">
                  <p>Đánh giá bác sỹ</p>
                </a>
              </li>
            </ul>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('service.add')); ?>" class="nav-link">
                  <p>Thêm dịch vụ</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('rateservice')); ?>" class="nav-link">
                  <p>Đánh giá dịch vụ</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('booking')); ?>" class="nav-link">
                  <p>Đặt lịch khám</p>
                </a>
              </li>
            </ul>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('file')); ?>" class="nav-link">
                  <p>Hồ sơ bệnh nhân</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('file.add')); ?>" class="nav-link">
                  <p>Thêm hồ sơ</p>
                </a>
              </li>
            </ul>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('menu')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('page')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('comment')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('slide')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('account')); ?>" class="nav-link">
          ...
          <div class="row">
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <a href="<?php echo e(route('post')); ?>"><span class="info-box-text">Tổng số bài viết</span></a>
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <a href="<?php echo e(route('file')); ?>"><span class="info-box-text">Tổng số hồ sơ</span></a>
                  <span class="info-box-number">
                    <?php 
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <a href="<?php echo e(route('comment')); ?>"><span class="info-box-text">Tổng số bình luận</span></a>
                  <span class="info-box-number">
                    <?php 
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <a href="<?php echo e(route('contact')); ?>"><span class="info-box-text">Tổng số liên hệ</span></a>
                  <span class="info-box-number">
                    <?php 
...
<?php /**PATH E:\fpoly\ĐỒ ÁN TỐT NGHIỆP\adminlte\resources\views/welcome.blade.php ENDPATH**/ ?>