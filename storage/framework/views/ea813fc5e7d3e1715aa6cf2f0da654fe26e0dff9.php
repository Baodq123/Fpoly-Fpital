				...
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-12">
                            ...
                            <img style="width: 200px; height: 150px;" src="<?php echo e($p->feature_images); ?>" alt="" class="img-fluid">
							</div>
							<div class="col-md-8" style="float: left; text-align: justify;">
                            <a href="/detail-<?php echo e($p->id); ?>"><h5><?php echo e($p->title); ?></h5></a>
...
<div class="sidebar-box ftco-animate">
	<div class="categories">
        ...
        <?php $__currentLoopData = $cates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<li><a href="/tin-tuc-<?php echo e($c->path); ?>"><?php echo e($c->name); ?> <span>(12)</span></a></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	</div>
</div>
<div class="sidebar-box ftco-animate" style="margin-top: -50px;">
	<h3>Bài viết được quan tâm</h3>
	<?php $__currentLoopData = $posts2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<div class="block-21 mb-4 d-flex">
		<a class="blog-img mr-4" style="background-image: url(images/image_1.jpg);"></a>
		<div class="text">
			<h5 class="heading"><a href="#"><?php echo e($item->title); ?></a></h5>
<!-- <div class="meta">
...
<?php echo $__env->make('layouts.blog-index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\fpoly\ĐỒ ÁN TỐT NGHIỆP\adminlte\resources\views/site/blog.blade.php ENDPATH**/ ?>