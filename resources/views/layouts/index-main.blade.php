...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="Fpital/css/owl.carousel.min.css">
    <link rel="stylesheet" href="Fpital/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="Fpital/css/magnific-popup.css">

    <link rel="stylesheet" href="Fpital/css/aos.css">

    <link rel="stylesheet" href="Fpital/css/ionicons.min.css">

    <link rel="stylesheet" href="Fpital/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="Fpital/css/jquery.timepicker.css">

    
    <link rel="stylesheet" href="Fpital/css/flaticon.css">
    <link rel="stylesheet" href="Fpital/css/icomoon.css">
    <link rel="stylesheet" href="Fpital/css/style.css">
  </head>
  <body>
			...
			<section class="ftco-section ftco-services">
					<div class="container" style="margin-bottom: -40px;">
						...
						<div class="row" style="margin-top: -70px;">
							...
							<div class="col-md-3 d-flex align-self-stretch ftco-animate">
								<div class="media block-6 services d-block text-center">
									<div class="icon d-flex justify-content-center align-items-center">
										<img src="Fpital/images/noibat_2.jpg" width="220px;" alt="">
									</div>
									<div class="media-body p-2 mt-3">
							...
							<div class="col-md-3 d-flex align-self-stretch ftco-animate">
								<div class="media block-6 services d-block text-center">
									<div class="icon d-flex justify-content-center align-items-center">
										<img src="Fpital/images/noibat_3.jpg" width="220px;" alt="">
									</div>
									<div class="media-body p-2 mt-3">
					...
					<div class="container-wrap mt-5">
						<div class="row d-flex no-gutters">
							<div class="col-md-6 img" style="background-image: url(Fpital/images/noibat_1.jpg);">
							</div>
						...
						<div class="container">
							...
							<div class="row" style="margin-top: -80px;">
								<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
									<div class="staff">
										<div class="img mb-4" style="background-image: url(Fpital/images/person_5.jpg);"></div>
				...
				<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
					<div class="staff">
						<div class="img mb-4" style="background-image: url(Fpital/images/person_6.jpg);"></div>
						<div class="info text-center">
							<h3><a href="teacher-single.html">Đỗ Quốc Bảo</a></h3>
							<span class="position">Trưởng khoa Nội</span>
							<div class="text">
				...
				<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
					<div class="staff">
						<div class="img mb-4" style="background-image: url(Fpital/images/person_7.jpg);"></div>
						<div class="info text-center">
							<h3><a href="teacher-single.html">Đỗ Quốc Bảo</a></h3>
							<span class="position">Trưởng khoa Nội</span>
							<div class="text">
				...
				<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
					<div class="staff">
						<div class="img mb-4" style="background-image: url(Fpital/images/person_8.jpg);"></div>
						<div class="info text-center">
							<h3><a href="teacher-single.html">Đỗ Quốc Bảo</a></h3>
							<span class="position">Trưởng khoa Nội</span>
							<div class="text">
		...
		<section class="ftco-section">
				<div class="container">
					...
					<div class="row" style="margin-top: -50px;">
						<div class="col-md-3">
							<div class="card">
								<img src="Fpital/images/image_4.jpg" class="card-img-top" alt="..." class="img-fluid">
								<div class="card-body">
							...
							<div class="row justify-content-center ftco-animate" style="margin-top: -75px;">
								<div class="col-md-8">
									<div class="carousel-testimony owl-carousel ftco-owl">
										...
										<div class="item">
											<div class="testimony-wrap p-4 pb-5">
												<div class="user-img mb-5" style="background-image: url(Fpital/images/person_2.jpg)">
													<span class="quote d-flex align-items-center justify-content-center">
														<i class="icon-quote-left"></i>
													</span>
												</div>
										...
										<div class="item">
											<div class="testimony-wrap p-4 pb-5">
												<div class="user-img mb-5" style="background-image: url(Fpital/images/person_3.jpg)">
													<span class="quote d-flex align-items-center justify-content-center">
														<i class="icon-quote-left"></i>
													</span>
												</div>
  ...
  <script src="Fpital/js/jquery.min.js"></script>
  <script src="Fpital/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="Fpital/js/popper.min.js"></script>
  <script src="Fpital/js/bootstrap.min.js"></script>
  <script src="Fpital/js/jquery.easing.1.3.js"></script>
  <script src="Fpital/js/jquery.waypoints.min.js"></script>
  <script src="Fpital/js/jquery.stellar.min.js"></script>
  <script src="Fpital/js/owl.carousel.min.js"></script>
  <script src="Fpital/js/jquery.magnific-popup.min.js"></script>
  <script src="Fpital/js/aos.js"></script>
  <script src="Fpital/js/jquery.animateNumber.min.js"></script>
  <script src="Fpital/js/bootstrap-datepicker.js"></script>
  <script src="Fpital/js/jquery.timepicker.min.js"></script>
  <script src="Fpital/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="Fpital/js/google-map.js"></script>
  <script src="Fpital/js/main.js"></script>
