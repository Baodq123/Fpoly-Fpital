	...
	<div class="row">
		<div class="col-md-12">
			<div class="card card-outline card-i  nfo">
				<form action="{{route('user.edit', ['id' => $model->id])}}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="card-body">
						...
						<div class="form-group">
							...
							<select class="custom-select" name="role_id" value="{{old('role_id', $model->role_id)}}">
								<option value="{{$model->role_id}}">
									<?php if ($model->role_id == 0): ?>
										Thành viên
									<?php endif ?>
