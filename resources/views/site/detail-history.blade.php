@extends('layouts.detail-history')
@section('container')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <form>
                ...
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Ngày khám</label>
                    <div class="col-sm-10">
                        <input type="text"
                            style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
                ...
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Bác sĩ khám</label>
                    <div class="col-sm-10">
                        <input type="text"
                            style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
