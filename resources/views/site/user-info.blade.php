								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text"
											...
											readonly class="form-control-plaintext" id="staticEmail" value=" {{$user->name}}">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text"
											style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
											readonly class="form-control-plaintext" id="staticEmail" value=" {{$user->email}}">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text"
											style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
											readonly class="form-control-plaintext" id="staticEmail" value=" {{$user->phone}}">
									</div>
								</div>
								<div class="form-group row">
