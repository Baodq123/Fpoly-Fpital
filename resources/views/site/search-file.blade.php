...
<div class="container">
    ...
    <div class="row justify-content-center mb-2 pb-2">
        <div class="col-md-7 text-center ftco-animate">
            <h2 class="mb-2" class="font-weight-bold"
                style="font-family: UTM Avo; font-weight: bold; color: #4e4e4e!important;font-size: 30px;">Tra cứu hồ sơ</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <form action="/tim-kiem-ho-so" method="POST">
                @csrf
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Nhập mã hồ sơ</label>
                    <div class="col-sm-10">
                        <input type="search" style="border: 1px solid #cccccc;width:80%;border-radius: 2px 2px;background: #eeeeee;color: #555555;" class="form-control-plaintext" name="tk" id="tk" value=" ">    
                    </div>
                </div>
                <div class="form-group row">
