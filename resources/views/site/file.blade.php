			...
			<div class="row">
				...
				<div class="col-md-9" style="height: 400px;">
						<div class="form-group row">
							...
							@foreach ($files as $f)
							<div class="form-group row">
									<label for="staticEmail" class="col-sm-2 col-form-label">Mã bệnh nhân</label>
									<div class="col-sm-10">
										<input type="text"
											style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
											readonly class="form-control-plaintext" id="staticEmail" value=" {{$f->code_patient}}">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text"
											style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
											readonly class="form-control-plaintext" id="staticEmail" value=" {{$f->name}}">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text"
											style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
											readonly class="form-control-plaintext" id="staticEmail" value=" {{$f->email}}">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text"
											style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
											readonly class="form-control-plaintext" id="staticEmail" value=" {{$f->phone}}">
									</div>
								</div>
								<div class="form-group row">
										<label for="staticEmail" class="col-sm-2 col-form-label">Tình trạng bệnh</label>
										<div class="col-sm-10">
											<input type="text"
												style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
												readonly class="form-control-plaintext" id="staticEmail" value=" {{$f->kind_disease}}">
										</div>
								</div>
								<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text"
												style="border: 1px solid #cccccc;border-radius: 2px 2px;background: #eeeeee;color: #555555;"
												readonly class="form-control-plaintext" id="staticEmail" value=" {{$f->doctor->name}}">
										</div>
								</div>
								@endforeach
								{{-- <div class="form-group row">
